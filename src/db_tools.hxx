...
public:
	...
	static void pack(const std::string& source_path, std::string& destination_path, const xray_re::DBVersion& version, const std::string& xdb_ud, const bool& dont_strip, const bool& skip_folders, boost::regex& expression, const size_t& max_size, const bool& save_list);
	static void packSplitted(const std::string& source_path, std::string& destination_path, const xray_re::DBVersion& version, const std::string& xdb_ud, const bool& dont_strip, const bool& skip_folders, boost::regex& expression, const size_t& max_size, const bool& save_list);
